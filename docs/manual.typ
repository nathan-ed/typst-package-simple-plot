#import "@preview/simple-plot:1.1.0": plot, plot-fn, plot-rational, limit-schema, schema-lim, scatter, data, line-plot, func-plot, parametric, fill-closed, fill-area, area-between, riemann-sum, note, vline, hline, volume-of-revolution, solid-of-revolution, zoom, set-plot-defaults, reset-plot-defaults
...
#table(
  ...
  [`label-bg`], [color/none], [white], [Background painted behind the axis labels where a grid line, a tick mark or a curve runs behind them. `none` turns it off, which is what a coloured page wants],
